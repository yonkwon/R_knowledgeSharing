---
title: "KSChannelGrapher: Graphing Tool for The Model of Knowledge Sharing (as opening knowledge channel)"
author: "Yon Kwon"
date: "8/28/2023"
...
set_fig1_outcome <- data$r.know.avg[set_fig1_beta, set_fig1_epsilon, , , set_fig1_t]
...
set_fig2_outcome <- data$r.know.avg[set_fig2_beta, set_fig2_epsilon, , , set_fig2_time]
...
fig2 <- ggplot(df_fig2, aes(x = time, y = outcome, color = p1, linetype = p2)) +
  geom_line() +
  scale_color_aaas(labels = parse_format()) +
  scale_linetype_manual(labels = parse_format(), values = c('dotted','dashed','solid','longdash')) +
...
fig2_params_label <- paste0(
  ...
  'e', data$para.a.e[set_fig2_epsilon],
...
## Figure 2. t * Knowledge Sharing -> Performance at Fixedx knowledge seeking
```{r fig2}
set_fig2_beta <- 1
set_fig2_epsilon <- 1
...
set_fig2_outcome <- data$r.know.avg[set_fig2_beta, set_fig2_epsilon, , set_fig2_p2, set_fig2_time]
set_fig2_outcome_label <- 'Firm Performance'
