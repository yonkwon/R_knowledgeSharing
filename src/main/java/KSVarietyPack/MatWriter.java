  ...
  MatWriter(Computation c) {
      ...
      for (int ps = 0; ps < Main.LENGTH_P_SHARING; ps++) {
        for (int t = 0; t < Main.TIME; t++) {
          for (int b = 0; b < Main.LENGTH_BETA; b++) {
            ...
            knowledgeSTD.setDouble(indices, c.knowledgeSTD[nt][ps][b][t]);
            knowledgeBestAVG.setDouble(indices, c.knowledgeBestAVG[nt][ps][b][t]);
            knowledgeBestSTD.setDouble(indices, c.knowledgeBestSTD[nt][ps][b][t]);
            knowledgeBestSourceDiversityAVG.setDouble(indices, c.knowledgeBestSourceDiversityAVG[nt][ps][b][t]);
            knowledgeBestSourceDiversitySTD.setDouble(indices, c.knowledgeBestSourceDiversitySTD[nt][ps][b][t]);
            knowledgeMinMaxAVG.setDouble(indices, c.knowledgeMinMaxAVG[nt][ps][b][t]);
            knowledgeMinMaxSTD.setDouble(indices, c.knowledgeMinMaxSTD[nt][ps][b][t]);
    ...
    try {
      MatFile matFile = mat5File
                        ...
                        .addArray("r_r_cont_avg", rankContributionPositiveAVG)
                        .addArray("r_r_cont_std", rankContributionPositiveSTD)
